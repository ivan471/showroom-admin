<div class="container">
  <h1 style="font-size:20pt">Daftar Mobil</h1>
  <br />
  ...
  <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th>Model</th>
                    <th style="width:70px;">Warna</th>
                    <th>Type</th>
                    <th style="width:90px;">No Polisi</th>
                    <th style="width:80px;">Transmisi</th>
...
<script src="<?php echo base_url('asets/jquery/jquery-2.1.4.min.js')?>"></script>
<script src="<?php echo base_url('asets/bootstrap/js/bootstrap.min.js')?>"></script>
<script src="<?php echo base_url('asets/datatables/js/jquery.dataTables.min.js')?>"></script>
<script src="<?php echo base_url('asets/datatables/js/dataTables.bootstrap.js')?>"></script>
...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="masa_berlaku_stnk"]').val(data.masa_berlaku_stnk);
            $('[name="kapasitas"]').val(data.kapasitas);
            $('[name="gambar1"]').val(data.gambar1);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Form Edit Data Mobil</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="tahun" placeholder="Last Name" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="model" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="warna" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="type" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="no_polisi" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Transmisi</label>
                            <div class="col-md-9">
                                <input name="transmisi" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="bahan_bakar" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kapasitas" placeholder="" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Masa Berlaku STNK</label>
                            <div class="col-md-9">
                                <input name="masa_berlaku_stnk" placeholder="gambar1" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Gambar 1</label>
                            <div class="col-md-9">
                                <input name="gambar1" placeholder="gambar1" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Gambar 2</label>
                            <div class="col-md-9">
                                <input name="gambar2" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Gambar 3</label>
                            <div class="col-md-9">
                                <input name="gambar3" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
